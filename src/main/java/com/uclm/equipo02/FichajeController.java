...
public class FichajeController {
	...
	@RequestMapping(value = "/abrirFichaje", method = {RequestMethod.POST, RequestMethod.GET})
	...
	@RequestMapping(value = "/cerrarFichaje", method = {RequestMethod.POST, RequestMethod.GET})
